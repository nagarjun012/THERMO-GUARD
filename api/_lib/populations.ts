...
export const DISTRICT_CENSUS_POPULATION: Record<string, number> = {
  // Major Urban and Disaster-Prone Districts (Sample from Census 2011 official tables)
  'Thane': 11060148,
...
/**
 * Resolves verified district population from official Census data.
 * Returns null if not verified (triggering DATA UNAVAILABLE instead of fabricated numbers).
 */
export function getDistrictPopulation(districtName: string, stateName?: string): number | null {
